...
bot = telebot.TeleBot('5103379589:AAEPZ0B503FT_6mU1h95kWTBWrgnbD7DwUw') # токен от бота в телеграм, создать бота можно тут - t.me/BotFather


number = '79037626797' # номер киви
token = '6724a367e0928ca55800a415cc6fa05c' # токен киви, взять тут - qiwi.com/api
api = QApi(token=token, phone=number)
sum = 150 # сколько мамонт должен заплатить
